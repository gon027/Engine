...
namespace engine {
	...
	DescriptorHeap::DescriptorHeap(UINT _numDescriptors, DescriptorType _type, DescriptorFlag _flag, UINT _nodeMask)
		: descriptorHeap(nullptr)
		, descriptorSize(0)
		, cpuHandle({})
		, gpuHandle({})
	...
	bool DescriptorHeap::init(UINT _numDescriptors, DescriptorType _type, DescriptorFlag _flag, UINT _nodeMask)
	{
		D3D12_DESCRIPTOR_HEAP_DESC desc{};
		desc.NumDescriptors = _numDescriptors;
		desc.NodeMask = _nodeMask;
